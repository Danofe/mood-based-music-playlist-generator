...
import { login, googlelogin } from './authcontext/authFunctions'
...
function Signin() {
  ...
  return (
    ...
    <div className='flex justify-center items-center'>
        <form onSubmit={handleLogin} className='flex flex-col w-1/2 h-full p-6 text-center rounded-lg bg-white bg-opacity-25 shadow-lg'>
            ...
            <button disabled={loading} className='w-full py-3 text-sm font-bold text-white transition duration-300 rounded-lg bg-gray-900 hover:bg-gray-700 focus:shadow-outline'>Sign In</button>
            <p className='mt-6 text-sm text-gray-100'>Don't have an account? <a href='#' className='text-gray-300 hover:underline'>Sign up</a></p>
        </form>
    </div>
    </div>
  )
